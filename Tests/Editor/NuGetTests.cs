...
using FreakshowStudio.NugetForUnity.Editor;
...
namespace FreakshowStudio.NugetForUnity.Tests.Editor
{
    public class NuGetTests
    {
        ...
        public void InstallSignalRClientTest()
        {
            ...
            var directory45 = Path.Combine(NugetHelper.NugetConfigFile.RepositoryPath,
                $"{signalRClient.Id}.{signalRClient.Version}\\lib\\net45");
