...
namespace NugetForUnity
{
    ...
    internal static class NugetCliHelper
    {
        ...
        {
            Directory.CreateDirectory(NugetCacheManager.CacheOutputDirectory);
            ...
            var arguments = $"pack \"{nuspecFilePath}\" -OutputDirectory \"{NugetCacheManager.CacheOutputDirectory}\" -NoDefaultExcludes";
        ...
        {
            var packagePath = nuspec.GetLocalPackageFilePath(NugetCacheManager.CacheOutputDirectory);
